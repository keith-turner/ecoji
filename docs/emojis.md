...
The following are emojis used in Ecoji V1 that were not in the set of [candidates](candidates.md) and were therefore not used in Ecoji V2. This information is provided for reference and is not needed to implement Ecoji
